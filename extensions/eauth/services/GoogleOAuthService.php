...
class GoogleOAuthService extends EOAuth2Service {
	...
	protected function fetchAttributes() {
		$info = (array)$this->makeSignedRequest('https://www.googleapis.com/plus/v1/people/me');
		...
		if(isset($info['emails'][0])){
			$emails = $info['emails'][0];
			$this->attributes['email'] = $emails->value;
		}
